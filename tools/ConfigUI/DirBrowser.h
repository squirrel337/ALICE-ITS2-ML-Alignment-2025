...
//
//  Shared verbatim with ALICE-ITS2-ML-Alignment-Manager
//  (RUN/ConfigUI/DirBrowser.h). Same author, same Apache-2.0 licence; keep
//  the two copies in step rather than letting them drift.
//
//  Modal. Use it as:
